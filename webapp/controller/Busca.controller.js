sap.ui.define([
    ...
    "use strict";
    return BaseController.extend("dma.zgenericos.controller.Busca", {
        onInit: function () {
        ...
        clearFornecedorEspecifico: function (oEvent) {
            var fornecedorInput = this.byId("fornecedorEspecifcoInput");
            fornecedorInput.setValue("");
            fornecedorInput.setDescription("");
            this.clearContrato(oEvent);
            this.habilitaBotaoPedido();
